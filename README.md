...
Como se puede observar, a veces también los avances tecnológicos y la hibridación puede ser controversial y no siempre positivo. Igualmente, yo opino que la aplicación, aunque sí que puede llegar a tener mucha información sobre nosotros, los demás no tienen por qué tenerla si ajustamos la privacidad de lo que compartimos. Igualmente, encuentro que la forma en la que esta aplicación permite vivir todos los elementos de manera conjunto, hace que sea adictivo, tanto en el mal como en el buen sentido. Nuestro cerebro se siente estimulado porque encuentra muchas formas de recibir información de otras personas, pero es que también permite una nueva forma de comunicarmos con los demás, intentando seguir la línea que defienden los creadores de ser "Real", sin filtros.
...
Asimismo, al ver productos como estos, podemos intuir cómo es nuestra actualidad, pero también cómo será nuestro futuro. Tendremos muchos avances tecnológicos, que permitiran realizar algo más que una hibridación de medios, muy presente ya en nuestras vidas. No sé hasta que punto se pondrá en juego nuestra privacidad para poder mejorar la experiencia todos y, si no nos sentiremos demasiados sobrestimulados al tener tantos elementos llevándose a cabo en un único espacio, pero de momento, ya se está comenzado a detectar en muchas de las interfaces que nos rodean. 
